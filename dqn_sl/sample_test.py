...
with open("/network/rit/lab/ceashpc/xujiang/eopinion_data/tmp/nodes-500-T-38-rate-0.1-testratio-0.2-swaprate-0.1-realization-0-data-X.pkl", 'rb') as f:
    data = pickle.load(f)
...
np.save("./data/sample/sub1_adj.npy", adj)
np.save("./data/sample/sub1_opinion.npy", opinion)
